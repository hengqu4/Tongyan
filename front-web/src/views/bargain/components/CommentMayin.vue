<template>
  <div>
    ...
    <div class="input">
      ...
      <div
        class="tools"
        style="color: #3ca1ff; text-align: center; margin-bottom: -23px"
      >
        <!-- <a-switch @change="changeRtcState" /> -->
        <div style="margin-right: 27px; cursor: pointer; display: inline-block">
          <a-icon
            type="close-circle"
            theme="twoTone"
            ...
            @click="cancelDraw"
          />
            <p style="font-size: 0.5px">取消</p>
        </div>
        <div style="margin-right: 20px; cursor: pointer; display: inline-block">
          <a-icon
            type="delete"
            theme="twoTone"
            style="text-align: center"
